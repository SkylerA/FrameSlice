...
// This assumes a name generated by FFmpeg which used 1 based indexing
function getParseName(file: string) {
  ...
  // This is -1 to account for FFmpeg's %d being 1 based indexing
  const idx = matches ? (Number(matches[2]) - 1) : 0;
